...
INSERT OR IGNORE INTO meta (key, value) VALUES ('schema_version','1'),('currency','EUR'),('created_with','basecero-pwa'),('locale','es-ES'),('import_account_id',''),('default_account_id',''),('partner_name',''),('category_style','{}'),('csv_profile',''),('lang','');
